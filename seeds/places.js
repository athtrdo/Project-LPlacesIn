  ...
  const places = [
    {
      ...
      image: "http://source.unpsplash.com/collection/583204/500x500",
    },
    {
      title: "Pantai Kuta",
      price: 0,
    ...
    const newPlace = await Promise.all( places.map(async(place) => {
      ...
      return {
        ...place,
         author: '66d9b846ecb1dfc6e55e0d08',
        images: {
        url: '/images/undefined-1726107319342-2.jpg',
        filename: 'undefined-1726107319342-2.jpg'
      },
      geoJSON: {...geoData}
    }
    }))
